...
function Tribute() {
  return (
    <div>
      <main id="main" className={styles.tributeMain}>
        <header>
          <h1 id="title" className={styles.tributeTitle}>
            Grace Hopper
          </h1>
          <h3 id="subtitle" className={styles.tributeSubtitle}>
            1906-1992
          </h3>
          <h2 id="subtitle" className={styles.tributeSubtitle}>
        ...
        <div id="img-div" className={styles.imgDiv}>
          ...
          />
          <div id="img-caption" className={styles.imgCaption}>
            <p className={styles.tributeLink}>
        ...
        <div id="tribute-info" className={styles.tributeInfo}>
          ...
          <section id="war-years">
            ...
            <ul className={styles.infoList}>
              ...
              <li>
                At the end of the war, {'Hopper’s'} request to join the regular
                Navy was refused on grounds of age, but she continued to serve
                in the Navy Reserve, remaining at the Harvard Computation lab
                until 1949.
              </li>
            </ul>
          </section>
          ...
          <section id="postscript" className={styles.postscript}>
            <h3>An Undeniable Legacy</h3>
            <ul className={styles.infoList}>
              <li>
                The Smithsonian {'Institute’s'} National Museum of American
                History houses a debugging relic from {'Hopper’s'} Harvard team.
                Working on the Mark II computer at the University, in 1947, her
                associates discovered a moth stuck in a relay, and obstructing
                computer operations. This was taped to a log sheet, with the
                comment “First actual case of bug being found” and was later
                preserved as a historical debugging case. Hopper was later
                credited for the term “debugging” taking hold in computing.{' '}
              </li>
              <li>
                ...
                {'I’m '}most proud of, the answer would be all the young people{' '}
                {'I’ve'}
                trained over the years; {'that’s'} more important than writing
                the first compiler.”
              </li>
              <li>
        ...
        <div className={styles.references}>
          <p className={styles.bold}>
            If you have enjoyed reading about the life of{' '}
            <em>amazing Grace </em>
            here, please check out the links below for further insights on her
            life and lasting legacy:
          </p>
          <br />
          <p className={`${styles.referencesLink}, ${styles.tributeLink} `}>
            <a
              href="https://news.yale.edu/2017/02/10/grace-murray-hopper-1906-1992-legacy-innovation-and-service"
              target="_blank"
            >
